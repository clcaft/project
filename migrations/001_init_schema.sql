...
CREATE TABLE IF NOT EXISTS departments (
    ...
    CONSTRAINT chk_departments_is_active CHECK (is_active IN (0, 1))
...
CREATE TABLE IF NOT EXISTS purchase_request_items (
    ...
    CONSTRAINT chk_purchase_request_items_quantity CHECK (quantity > 0),
...
CREATE TABLE IF NOT EXISTS delivery_invoice_items (
    ...
    CONSTRAINT chk_delivery_invoice_items_quantity CHECK (quantity > 0),
    CONSTRAINT chk_delivery_invoice_items_price CHECK (price >= 0),
...
CREATE TABLE IF NOT EXISTS internal_transfer_invoices (
    ...
    CONSTRAINT chk_internal_transfer_departments CHECK (from_department_id <> to_department_id),
...
CREATE TABLE IF NOT EXISTS internal_transfer_invoice_items (
    ...
    CONSTRAINT chk_internal_transfer_invoice_items_quantity CHECK (quantity > 0),
...
CREATE TABLE IF NOT EXISTS inventory_balances (
    ...
    CONSTRAINT chk_inventory_balances_quantity CHECK (quantity >= 0),
